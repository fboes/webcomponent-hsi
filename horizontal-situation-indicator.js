...
<rect id="hsi-base" y="229.27" width="67.733" height="67.733" style="paint-order:stroke fill markers"/>
<circle cx="33.866" cy="263.13" r="17.395" fill="none" stroke="#fff" stroke-width=".74999" style="paint-order:stroke fill markers"/>
</g>
<g>
<g id="heading">
<g id="nav2-course">
<g id="nav2-deviation" fill="#0ff">
<rect x="33.337" y="17.991" width="1.0583" height="31.75" style="paint-order:stroke fill markers"/>
<path id="nav2-to" d="m31.22 29.633 2.6458-1.0583 2.6458 1.0583-2.6458-5.5562z" stroke="#000" stroke-width=".26458px"/>
</g>
<g fill="none" stroke="#fff" stroke-width=".49999">
...
<path d="m33.866 5.5562-3.9687 6.3499 3.4395-1.3229v6.8791h1.0583v-6.8791l3.4395 1.3229zm-0.52916 44.714v11.906h1.0583v-11.906z" fill="#0ff" style="paint-order:stroke fill markers"/>
</g>
<path id="nav1-bearing" d="m29.104 12.435 3.9687-1.3229v6.3499h-0.26458v-5.8208l-4.4979 1.3229 5.5562-8.4666v0.52916z" fill="#f0f"/>
<g id="nav1-course">
<g id="nav1-deviation" fill="#f0f">
<rect x="33.337" y="17.991" width="1.0583" height="31.75" style="paint-order:stroke fill markers"/>
<path id="nav1-to" d="m31.22 29.633 2.6458-1.0583 2.6458 1.0583-2.6458-5.5562z" stroke="#000" stroke-width=".26458px"/>
</g>
<g fill="none" stroke="#fff" stroke-width=".49999">
<circle cx="48.179" cy="33.866" r="1.1407" style="paint-order:stroke fill markers"/>
<circle cx="41.139" cy="33.866" r="1.1407" style="paint-order:stroke fill markers"/>
...
<path id="nav1-course-pointer" d="m33.866 5.5562-3.9687 6.3499 3.4395-1.3229v6.8791h1.0583v-6.8791l3.4395 1.3229zm-0.52916 44.714v11.906h1.0583v-11.906z" fill="#f0f" style="paint-order:stroke fill markers"/>
</g>
...
<path d="m36.247 38.629v-0.52916l-1.8521-1.5875 0.26458-2.1166 3.4395 1.0583v-1.0583l-3.4395-2.6458v-1.5875l-0.52916-1.5875h-0.26501 8.52e-4 -0.26501l-0.52916 1.5875v1.5875l-3.4395 2.6458v1.0583l3.4395-1.0583 0.26458 2.1166-1.8521 1.5875v0.52916l2.3812-0.52916z" fill="#fff"/>
<path d="m29.633 0v1.3229h2.3812l1.8521 1.8521 1.8521-1.8521h2.3812v-1.3229z"/>
<path d="m29.633 1.3229h2.3812l1.8521 1.8521 1.8521-1.8521h2.3812" fill="none" stroke="#fff" stroke-width=".26458px"/>
...
<use transform="rotate(-90 33.866 33.866)" width="100%" height="100%" xlink:href="#use976"/>
</g>
</svg>`;
...
class HorizontalSituationIndicator extends HTMLElement {
  ...
  constructor() {
    ...
    this.constructor.observedAttributes.forEach((attrName) => {
      ...
      if (element) {
        this._log('Registering DOM element for', attrName);
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    switch (matches[2]) {
      case 'to':
        el.setAttribute('transform','rotate(' + [this[attrName] > 0 ? 0 : 180 , this._svg.centerX, this._svg.centerY].join(' ') + ')');
        break;
      case 'deviation':
        let value = this[attrName];
        if (value < -90) { value += 180; value *= -1; }
        else if (value > +90) { value -= 180; value *= -1; }
        value = Math.max(-10, Math.min(10, value)) * -1.45;
        el.setAttribute('transform','translate(' + value + ' 0)');
        break;
      default:
        el.setAttribute('transform','rotate(' + [this[attrName], this._svg.centerX, this._svg.centerY].join(' ') + ')');
        break;
    }
  }
